          ...
          TextButton(
            onPressed: () async {
              ...
              try {
                ...
                final competitionAnalysis =
                    result["competition_analysis"] as String? ?? "";

                // Update provider with all data
                final provider = context.read<RecommendationProvider>();
                provider.setRecommendations(crops);
                provider.setWeather(weatherData);
                provider.setCompetitionAnalysis(competitionAnalysis);
              } catch (e) {
                if (context.mounted) {
                  Navigator.pop(context);
